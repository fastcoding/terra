...
elseif(TERRA_LUA STREQUAL "system")
  set(LUAJIT_NAME "LuaJIT")
  set(LUAJIT_BASE "luajit")
  set(LUAJIT_VERSION_MAJOR 2)
  set(LUAJIT_VERSION_MINOR 1)
  ...
  set(LUAJIT_EXECUTABLE "${LUAJIT_PREFIX}/bin/luajit" )
  set(LUAJIT_INCLUDE_DIR "${LUAJIT_INCLUDEDIR}")
  add_custom_target(LuaJIT 
	  DEPENDS  PkgConfig::LUAJIT
	  ) 
  set(LUAJIT_OBJECTS ${LUAJIT_LINK_LIBRARIES})
  set(LUAJIT_OBJECTS_STATIC ${LUAJIT_PREFIX}/lib/libluajit-5.1.a)
  RETURN()
else()
